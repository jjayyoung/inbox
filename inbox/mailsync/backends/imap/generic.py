...
class FolderSyncEngine(Greenlet):
    ...
    def initial_sync_impl(self, crispin_client, local_uids,
        ...
        with mailsync_session_scope() as db_session:
            self.update_uid_counts(
                ...
                # Flags are updated in imap_flag_change_poller() and
        ...
        if spawn_flags_refresh_poller:
            flags_refresh_poller = spawn(self.imap_flag_change_poller)
    ...
    def create_message(self, db_session, acct, folder, msg):
        ...
        new_uid = self.add_message_attrs(db_session, new_uid, msg.flags,
                                         folder, msg.created)
        return new_uid

    def add_message_attrs(self, db_session, new_uid, flags, folder, created):
    ...
    def imap_flag_change_poller(self):
        """
